...
/* harmony import */ var _modules_contact__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/contact */ "./js/modules/contact.js");
/* harmony import */ var _modules_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/menu */ "./js/modules/menu.js");
/* harmony import */ var _modules_removeFromCart__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/removeFromCart */ "./js/modules/removeFromCart.js");
...
Object(_modules_removeFromCart__WEBPACK_IMPORTED_MODULE_4__["updateSum"])(Object(_modules_removeFromCart__WEBPACK_IMPORTED_MODULE_4__["calculateSum"])());
document.addEventListener('click', function (e) {
  var changeValueBtn = e.target.closest('.change-value-btn');
  var btnRemoveItem = e.target.closest('.order__item-remove');

  if (changeValueBtn) {
    Object(_modules_swiper__WEBPACK_IMPORTED_MODULE_1__["changeValue"])(changeValueBtn);
  }

  if (btnRemoveItem) {
    Object(_modules_removeFromCart__WEBPACK_IMPORTED_MODULE_4__["removeFromCart"])(btnRemoveItem);
  }
});
...
var galleryThumbs = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.contact__wrap-slider-bottom', {
  watchSlidesVisibility: true,
  watchSlidesProgress: true,
  slidesPerView: 'auto'
});
var swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.contact__wrap-slider-top', {
  thumbs: {
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var perсentForSwipe = 0.1; // процент перетаскивания чтобы сработал доезд окна

  var isSwipingMenu = false; // на данный момент меню перетаскивается?

  var isTouchEvent = false;
  var touch = 'pointerdown';
  var touchMove = 'pointermove';
  var touchUp = 'pointerup';
  ...
  var resolveForSwipe = function resolveForSwipe(value, maxValue, isMenuOpen) {
    if (isMenuOpen) {
  ...
  var swipeMenu = function swipeMenu(evt) {
    var parent = evt.target.parentElement;
    var isMenuOpen = false;
    var initialPosition = 0;
    var shift = 0;
    var minEdge = 0;
    var maxEdge = parent.offsetHeight;
    ...
    var touchY = isTouchEvent ? evt.changedTouches[0].clientY : evt.clientY;

    var onMove = function onMove(e) {
      isSwipingMenu = true;
      var y = isTouchEvent ? e.changedTouches[0].clientY : e.clientY;
      ...
      parent.style.cssText = "transform: translate3d(-50%, ".concat(-shift, "px, 0); transition: none");
    };

    var onTouchUp = function onTouchUp() {
      setTimeout(function () {
        // чтобы событие отработало после других обработчиков
        isSwipingMenu = false;
      });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MultiModal; });
...
var MultiModal = /*#__PURE__*/function () {
  ...
  _createClass(MultiModal, [{
    ...
    value: function open(selector, multiple, opener) {
      ...
      var activeClass = this.currentWindow.modal.dataset.activeClass;
    ...
    value: function close(selector, multiple, opener) {
      ...
      var currentWindow = this.openedWindows[this.openedWindows.length - 1];
...
/***/ "./js/modules/removeFromCart.js":
/*!**************************************!*\
  !*** ./js/modules/removeFromCart.js ***!
  \**************************************/
/*! exports provided: calculateSum, updateSum, removeFromCart */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calculateSum", function() { return calculateSum; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateSum", function() { return updateSum; });
...
var calculateSum = function calculateSum() {
  var sum = 0;
  var sumItems = document.querySelectorAll('.order__item-price');
  sumItems.forEach(function (item) {
    var price = +(item === null || item === void 0 ? void 0 : item.dataset.price);
...
var updateSum = function updateSum(sum) {
  var totalSum = document.querySelector('.order__total');
...
var removeFromCart = function removeFromCart(btn) {
  var row = btn.closest('.order__item');
...
var modalObj = new _modal__WEBPACK_IMPORTED_MODULE_0__["default"]();
var btnSearch = document.querySelector('.nav__link-search');
...
var fruitSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-container', {
  loop: true,
  // spaceBetween: 100,
  navigation: {
    nextEl: '.btn-next',
...
var changeValue = function changeValue(btn) {
  var valueNode = document.querySelector('.fruits-slider__value');
