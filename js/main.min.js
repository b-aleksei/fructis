...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var persentForSwipe = 0.1;
  var isSwipingMenu = false;
  var isTouch = false;
  ...
  var resolveStatus = function resolveStatus(value, maxValue) {
    if (document.body.classList.contains('nav-menu-active')) {
      return Math.abs(value) < maxValue * (1 - persentForSwipe);
    } else {
      return Math.abs(value) > maxValue * persentForSwipe;
    }
  };
  ...
  var swipeMenu = function swipeMenu(evt) {
    ...
    var touchY = isTouch ? evt.changedTouches[0].clientY : evt.clientY;
